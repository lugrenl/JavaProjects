...
public class NIOServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Cелекторы не просто помогают вам читать данные; они также могут прослушивать входящие
        // сетевые соединения и записывать данные по каналам.
        ...
        // Cоздаём ByteBuffer, с которого сервер будет писать и читать.
    ...
    public static Process start() throws IOException {
        ...
        String javaBin = STR."\{javaHome}\{File.separator}bin\{File.separator}java";
